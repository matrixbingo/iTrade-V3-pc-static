...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (Host) {
	  ...
	  patchVersion('7.9.4', __webpack_require__(31));
	  patchVersion('7.9.6', __webpack_require__(32));
	  patchVersion('8.0.0', __webpack_require__(33));
	  patchVersion('8.0.4', __webpack_require__(34));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core = module.exports = new Core({
	  ...
	  _doSendMessage: function (method, args, callback) {
	    ...
	    if (method === 'getCX') {
	      //临时修复getCX超时的问题
	      core._getCXTimeout = setTimeout(function() {
	        window[callbackName]({status: 'fail', msg: 'Timeout'});  
	      },1000);      
	    }
	  ...
	  _send: function(method, args){
	    ...
	    var callback = (_success || _fail || _handle) ? function(result){
	      ...
	      if(status == "success"){
	        // 如果成功获取getCX则取消定时器
	        if (method === 'getCX') {
	          clearTimeout(core._getCXTimeout);
	          core._getCXTimeout = null;
	        }
